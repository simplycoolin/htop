...
- **emer_brake.cpp ** - # Emergency Brake Simulation (C++) - This project simulates an autonomous vehicle's emergency braking system using C++.
- **distance_safety.cpp** - “C++ AV Test: Collision Risk & Emergency Braking”
- 
